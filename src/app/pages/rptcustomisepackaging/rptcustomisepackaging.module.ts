...
import {  RptcustomisepackagingPageRoutingModule } from './rptcustomisepackaging-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    IonicModule,
    RptcustomisepackagingPageRoutingModule,
    FontAwesomeModule,
...
export class RptcustomisepackagingPageModule {}
