...
@Component({
  selector: "app-rptstockbal",
  templateUrl: "./rptstockbal.page.html",
  styleUrls: ["./rptstockbal.page.scss"],
})
export class RptstockbalPage implements OnInit, OnDestroy {
  ...
  async download(){
    ...
    this.loading.present();
    let serv = (await this.orderService.downloadproductpPlan(obj)).subscribe((res) => {
      debugger;
      serv.unsubscribe();
      this.loading.dismiss();
      if (res[0].Result_Code == 1) {
