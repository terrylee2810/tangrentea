...
import {  RptdeliverybreakdownPageRoutingModule } from './rptdeliverybreakdown-routing.module';
...
@NgModule({
  imports: [
    ...
    FormsModule,
    IonicModule,
    RptdeliverybreakdownPageRoutingModule,
    FontAwesomeModule,
...
export class RptdeliverybreakdownPageModule {}
